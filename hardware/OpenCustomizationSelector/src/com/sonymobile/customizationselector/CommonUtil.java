...
public class CommonUtil {
    ...
    public static PersistableBundle getCarrierBundle(Context context) {
        ...
        String parseModemConf = ModemConfParser.parseModemConf(configId);
        CSLog.i(TAG, String.format("Returning bundle with sim id %s, modem: %s, config id: %s", simId, parseModemConf, configId));

        PersistableBundle bundle = new PersistableBundle(3);
        bundle.putString(Configurator.KEY_SIM_ID, simId);
        bundle.putString(Configurator.KEY_MODEM, parseModemConf);
